...
function Calendar({
  ...
  const _captionLabelClassName = cn('truncate text-sm font-semibold', props.captionLabelClassName)
        ...
        return (
          <Button
            ...
            className={cn(
              ...
              displayYears.from + i === new Date().getFullYear() && 'bg-accent text-accent-foreground font-semibold'
            )}
            variant='ghost'
            onClick={() => {
              setNavView('days')
